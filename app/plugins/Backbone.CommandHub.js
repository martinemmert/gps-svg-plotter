...
define(["underscore", "backbone"], function (_, Backbone) {
    ...
    _.extend(CommandHub.prototype, {
        initialize: function () {
            ...
            //-------------------------------------------------------------------------------------------------------------
            // create the shortcut
            Backbone.executeCommand = function (commandName, params, callback, context) {
                that._onExecuteCommand(commandName, params, callback, context);
            };

            //-------------------------------------------------------------------------------------------------------------
            // define the global namespace for available commands
            Backbone.availableCommands = Backbone.availableCommands || {};
        ...
        _onExecuteCommand: function (commandName, params, callback, context) {
            if (this._commands[commandName] != undefined) {
                ...
                //DEBUG:START
                console.warn("CommandHub >> " + commandName + " is not registered!");
                //DEBUG::END
            }
        },
    ...
    return Backbone.CommandHub = new CommandHub();
